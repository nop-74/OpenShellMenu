...
> [!ВАЖНО]
> #### Совместимость с Windows для ARM
> Open-Shell совместима с Windows для ARM начиная с версии [4.4.196](https://github.com/Open-Shell/Open-Shell-Menu/releases/tag/v4.4.196).
>
